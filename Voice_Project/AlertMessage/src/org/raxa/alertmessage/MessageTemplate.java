...
public class MessageTemplate implements MessageInterface {
		...
		/**
		 * Right now the text for both sms and voice are same but if we want to change it this function also gets alertType
		 ...
		 * 
		 * Depending on the alertType the message can be varied.Right now its same for both.
		 * @param message
